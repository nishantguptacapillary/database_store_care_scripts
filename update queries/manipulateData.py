...
install["date_installed"] = install["date_installed"].replace(np.nan, "")
install["device_name"] = install["device_name"].replace(np.nan, "")
install["date_callback"] = install["date_callback"].replace(np.nan, "")
